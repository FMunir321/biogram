      ...
      <div className="bg-white rounded-[32px] p-4 md:p-6">
        ...
        <div className="mb-6 md:mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="w-full max-w-md bg-gradient-to-r from-pink-100 to-pink-50 rounded-full p-1">
              <input
                type="text"
            ...
            <button className="w-full sm:w-auto bg-gradient-to-r from-[#FF5733] to-[#FF1493] text-white px-6 py-2 rounded-full text-sm font-medium">
              Search
            </button>
          </div>
        </div>
