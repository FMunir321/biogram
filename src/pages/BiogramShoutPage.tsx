      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center z-10 mt-25">
        ...
        <div>
          <h1 className="text-7xl  font-bold text-black ">
            Less stress. <span className="text-7xl font-bold text-black">More results.</span>
          </h1>
          ...
          <div className="mt-8">
            <button className="bg-gradient-to-r from-[#7ECFA7] to-[#53886C] hover:from-[#53886C] hover:to-[#7ECFA7] text-white font-semibold py-3 px-8 rounded-full transition-all">
