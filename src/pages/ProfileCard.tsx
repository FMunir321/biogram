  ...
  return (
    <div className="bg-white py-16 px-6 md:px-12 flex flex-col items-center text-center">
      ...
      <p className="text-gray-600 mt-4 max-w-xl">
        With endless styles, colors, and layouts, you can create a Link with biogram that matches your vibe and brand perfectly. Show your individuality. Stand out in every click
      </p>
  ...
  {[
    ...
    >
      <Icon style={{ color }} size={22} />
        ...
        {/* Main Card */}
        <Card className="z-50 w-110 bg-black text-white rounded-2xl shadow-xl relative">
...
<div className="mt-6 grid grid-cols-5 gap-10">
  {["/theme1.png", "/theme2.png", "/theme3.png", "/theme4.png", "/theme5.png"].map((_, idx) => {
    const bgColors = ["bg-pink-500", "bg-green-500", "bg-yellow-400", "bg-red-500", "bg-blue-500"];return (
        <div
          key={idx}
        ...
        >
          <img src={avatar} alt={`theme-${idx}`} className="w-10 h-10" />
        </div>
      );
    })}
</div>
        ...
        <img src={mock5} alt="bg4" className="rounded-2xl shadow-lg h-[570px]" />
