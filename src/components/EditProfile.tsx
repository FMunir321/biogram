    ...
    <div className="w-full h-[calc(100vh-30px)] mx-auto  ">
      ...
      >
        <div className="flex flex-col lg:flex-row lg:gap-5 2xl:gap-4 w-full h-full">
          <div className="flex flex-col gap-4 md:w-[500px] h-auto md:h-full md:max-h-[calc(100vh-30px)] md:overflow-y-auto  md:overflow-x-hidden p-5 pt-10">
            {/* Add photo card */}
          ...
          <div className="flex-1 pb-6 h-auto md:max-h-[calc(100vh-30px)] md:overflow-y-auto  mt-8">
