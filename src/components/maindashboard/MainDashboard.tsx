        ...
        {selectedUser ? (
          <>
            ...
            <div className=" cursor-pointer mt-10 relative">
              <div className="absolute bottom-56 left-0 w-full h-29 bg-gradient-to-t from-black/100 to-transparent z-10"></div>
              <div
              ...
              <div className="inset-0  flex flex-col items-center justify-center mt-[-150px] z-10 bg-gradient-to-t from-black/100 to-transparent">
                ...
                <div className="hidden">
                  <img
                    src={biogram}
                    alt="Biogram Logo"
                    className="w-16 h-18 mt-4 "
                  />
                </div>
              </div>

              <div
                className="bg-black w-full max-w-[400px] rounded-b-2xl pb-8 pt-4 "
                onClick={() => handleClickOnProfile(selectedUser._id)}
              >
                <div className="flex justify-center gap-8 ">
                  <button
                    className={`text-lg font-semibold rounded-none ${
                      activeTab === "shouts" ? "text-blue-400" : "text-white"
                    }`}
                  ...
                  <button
                    className={`text-lg font-semibold rounded-none ${
                      activeTab === "media" ? "text-blue-400" : "text-white"
                    }`}
