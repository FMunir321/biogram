...
const Profile = () => {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8 py-6">
      <div className="bg-gradient-to-br from-pink-100 to-pink-200 rounded-[32px] p-4 md:p-6 relative min-h-[500px]">
        {/* Header */}
        ...
        <div className="relative z-10 text-center mt-16 md:mt-32">
          ...
          <Link to="/profilemaindashboard">
            <Button 
              className="bg-white hover:bg-gray-50 text-gray-900 font-medium rounded-full px-6 md:px-8 py-2 md:py-3 text-sm md:text-base cursor-pointer"
            >
              Create Your Profile
            </Button>
          </Link>
