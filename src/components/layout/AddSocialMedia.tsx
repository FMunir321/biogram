...
//                 <button className="flex items-center gap-1 bg-blue-100 text-blue-700 px-3 py-1 rounded-md hover:bg-blue-200 transition">
//                   <FaRegEdit />
//                   Edit
//                 </button>
//                 <button className="flex items-center gap-1 bg-red-100 text-red-700 px-3 py-1 rounded-md hover:bg-red-200 transition">
//                   <MdDelete />
//                   Delete
//                 </button>
//               </div>
